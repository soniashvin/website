...
<link rel="stylesheet" type="text/css" href="placesToBe.css">
...
<body>
    ...
    <img src="images/logo.png" style="background-color: black" width="50" height="50" alt="">
        ...
        <ul class="navbar-nav ml-auto">
         ...
         <div class="grey-border">
             <div class="container">
                 <div class="center-text "> <h2>Vacations</h2></div>
             </div>
    ...
    <div data-spy="scroll" data-target="#navbar-example2" data-offset="0"><div id="overview" class="overview">
            <div class="container">
                ...
                <div class="row overview-row">
                    <div class="card-deck">
                        <div class="card card-border ">
                           <a href='#'>
                            <img src="images/Karnataka.jpg" class="card-img-top colImg" alt="Karnataka" >
                        ...
                        <div class="card card-border" >
                            <a href=#'>
                            <img src="images/punjab.jpg" class="card-img-top colImg" alt="punjab" >
                            <div class="card-footer" style="padding: 15px 5px !important;">
                        ...
                        <div class="card card-border">
                            <a href=#'">
                            <img src="images/Rajasthan.jpg" class="card-img-top colImg" alt="Rajasthan" >
                            <div class="card-footer" style="padding: 15px 5px !important;">
                        ...
                        <div class="card card-border">
                            <a href=#' >
                            <img src="images/Gujarat.jpg" class="card-img-top colImg" alt="gujrat">
                            <div class="card-footer" style="padding: 15px 5px !important;">
